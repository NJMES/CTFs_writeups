...
static? link(https://mercury.picoctf.net/static/bc72945175d643626d6ea9a689672dbd/static)
This BASH script link(https://mercury.picoctf.net/static/bc72945175d643626d6ea9a689672dbd/ltdis.sh)
might help!
...
process: 
    - wget https://mercury.picoctf.net/static/bc72945175d643626d6ea9a689672dbd/static
      - cat static
      - result: wierd unreadable text. likely an image.
    - wget https://mercury.picoctf.net/static/bc72945175d643626d6ea9a689672dbd/ltdis.sh
      - ./ltdis.sh
      - result: -bash: ./ltdis.sh: Permission denied
    - I need to chmod +x ltdis.sh ???

    - ./ltdis.sh
      - result: 
Attempting disassembly of  ...
objdump: 'a.out': No such fileH-F SAIL)HWHt 1LLDAHH9u[]A\A]A^A_Ðf.Oh hai! Wait what? A flag? Yes, it's around here somewhere!8
 ...
 **1020 picoCTF{d15a5m_t34s3r_1e6a7731}**
   ...
   1969 .bss
   196e .comment
    - found this: 1020 picoCTF{d15a5m_t34s3r_1e6a7731}
